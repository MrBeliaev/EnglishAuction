        ...
        it('stopTime', async () => {
            ...
            describe('Bid', () => {
                ...
                it('price', async () => {
                    ...
                    result.toString().should.equal("3000")   
                })
            ...
            describe('Withdraw', () => {
                ...
                it('Withdraw event', async () => {
                    ...
                    time = event.withdrawTime.toString()
                    console.log((new Date(time*1000)).toLocaleString())
                })
                ...
                describe('End', () => {
                    ...
                    it('End event', () => {
                        ...
                        event.amount.toString().should.equal("3000")
                    })

                    it('withdraw after end', async () => {
                        await auction.withdraw({ from: user3})
